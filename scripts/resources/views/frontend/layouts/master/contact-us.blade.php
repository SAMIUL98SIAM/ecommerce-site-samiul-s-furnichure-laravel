        ...
        <div class="container">
            <div class="flex-w flex-tr">
                <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    <form method="post" action="{{route('frontend.contact_us.store')}}" id="form">
                        @csrf
                       ...
                       @endif
                        <div class="bor8 m-b-20 how-pos4-parent">
                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="name" placeholder="Your Name" value="{{old('name')}}" required="">
                            <img class="how-pos4 pointer-none" src="{{asset('/frontend/images/icons/user.png')}}" alt="ICON">
                            <font color="red"><b></b></font>
                        </div>

                        <div class="bor8 m-b-20 how-pos4-parent">
                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="email" name="email" placeholder="Your Email Address" value="{{old('email')}}" required="">
                            <img class="how-pos4 pointer-none" src="{{asset('/frontend/images/icons/icon-email.png')}}" alt="ICON">
                            <font color="red"><b></b></font>
                        </div>

                        <div class="bor8 m-b-20 how-pos4-parent">
                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="mobile" placeholder="Your Mobile Number" value="{{old('mobile')}}" required="">
                            <img class="how-pos4 pointer-none" src="{{asset('/frontend/images/icons/mobile.png')}}" alt="ICON">
                            <font color="red"><b></b></font>
                        </div>

                        <div class="bor8 m-b-30">
                            <textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="msg" placeholder="Your Message" required="">{{old('msg')}}</textarea>
                            <font color="red"><b></b></font>
                        </div>
