...
@section('content')
    ...
    <section class="section-slide">
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1" style="background-image: url({{asset('/frontend/images/slider/slider-1.jpg')}});">
                ...
                <div class="item-slick1" style="background-image: url({{asset('/frontend/images/slider/slider-2.jpg')}});">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                ...
                <div class="item-slick1" style="background-image: url({{asset('/frontend/images/slider/slider-3.jpg')}});">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
